...
/*!
* \def QSMD_SIGNATURE_KEY_SERIALIZED_SIZE
* \brief The secret signature key serialized size
*/
#define QSMD_SIGNATURE_KEY_SERIALIZED_SIZE (QSMD_KEYID_SIZE + \
	QSMD_TIMESTAMP_SIZE + \
	QSMD_CONFIG_SIZE + \
	QSMD_ASYMMETRIC_SIGNING_KEY_SIZE + \
	QSMD_ASYMMETRIC_VERIFY_KEY_SIZE)

/*!
* \def QSMD_VERIFICATION_KEY_SERIALIZED_SIZE
* \brief The verification key serialized size
*/
#define QSMD_VERIFICATION_KEY_SERIALIZED_SIZE (QSMD_KEYID_SIZE + \
	QSMD_TIMESTAMP_SIZE + \
	QSMD_CONFIG_SIZE + \
	QSMD_ASYMMETRIC_VERIFY_KEY_SIZE)
